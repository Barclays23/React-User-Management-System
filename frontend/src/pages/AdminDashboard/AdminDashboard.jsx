...
function AdminDashboard() {
   ...
   const handleEdit = (user) => {
      ...
      if (user.profilePic) { // if existing profile pic
         setImagePreview(`http://localhost:5000/uploads/profile-pics/${user.profilePic}`);
   ...
   return (
      <div className="min-h-screen p-2 sm:p-3 lg:p-2">
         <div className="max-w-7xl mx-auto">
            <div className='mb-7 sm:mb-2'>
               <h2 className="text-center text-4xl font-bold text-gray-400 my-7"> Admin Dashboard </h2>
            </div>

            <div className="bg-gradient-to-b from-blue-200 to-gray-700 rounded-2xl shadow-xl p-6 sm:p-8">

               <div className="text-right mb-8">
                  <button
                     onClick={() => setShowModal(true)}
                     className="bg-gradient-to-r from-blue-600 to-indigo-600 text-white px-6 py-2 rounded-full hover:from-blue-700 hover:to-indigo-700 transition-all duration-300 shadow-md cursor-pointer"
                  >
                     Create User
                  </button>
               </div>
               ...
               <h3 className="text-2xl font-bold text-center text-gray-800 mb-6">User Management</h3>
               ...
               <div className="mb-8">
                  <div className="relative">
                     ...
                     className="w-full p-3 pl-10 border border-gray-400 rounded-full focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none transition-all duration-300 bg-gray-50"
                     />
                     <svg
               ...
               <div className="flex justify-center mt-6 gap-2">
                  <button
                     ...
                     disabled={page === 1}
                     className="px-4 py-2 bg-gray-700 hover:bg-gray-800 text-white rounded disabled:opacity-50 cursor-pointer"
                  >
                     Prev
                  </button>

                  <span className="px-4 py-2 text-gray-100 bg-gray-800 rounded">
               ...
               <div className="overflow-x-auto px-4 py-6">
                  <div className="rounded-lg overflow-hidden shadow-lg bg-gray-900">
                     <table className="min-w-full divide-y divide-gray-700">
                        <thead className="bg-gray-900">
                           <tr>
                              ...
                              <th className="px-6 py-3 text-center text-xs font-medium text-gray-300 uppercase tracking-wider">Mobile</th>
                        ...
                        <tbody className="divide-y divide-gray-700">
                           {allUsers.map((user, index) => (
                              <tr key={user._id} className="bg-gray-800 hover:bg-gray-900">
                                 ...
                                 <td className="px-6 py-4 text-sm text-gray-100 font-semibold">{user.name}</td>
                                 <td className="px-6 py-4 text-sm text-gray-400">{user.email}</td>
                                 <td className="px-6 py-4 text-sm text-center text-gray-400">{user.mobile || "-"}</td>
                                 ...
                                 <button
                                    ...
                                    className="bg-indigo-500 hover:bg-indigo-700 text-white px-3 py-1 rounded-full text-xs cursor-pointer"
                                 >
                                    Edit
                                 </button>
                                 <button
                                    onClick={() => handleDelete(user._id)}
                                    className="bg-red-600 hover:bg-red-800 text-white px-3 py-1 rounded-full text-xs cursor-pointer"
                                 >
                                    Delete
                                 </button>
                                 </td>
                     ...
                     {allUsers.length === 0 && (
                        <div className="text-center py-8 text-gray-400 bg-gray-900">No users found</div>
                     )}
                  </div>
               </div>
               ...
               {allUsers.length === 0 ? (
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
                     ...
                     <div
                        key={user._id}
                        className="bg-gray-800 hover:bg-gray-900 rounded-xl shadow-md hover:shadow-xl transition-all duration-300 ease-in-out p-6 flex flex-col items-center text-center transform hover:scale-[1.02] hover:ring-2 hover:ring-blue-500/40"
                     >
                        <img
                           src={
                           user.profilePic
